...
if (isset($_POST["volverDepartamento"])) {
...
$aFormulario = ['CodDepartamentos' => null,
    ...
    'FechaBaja' => null,
    'VolumenNegocio' => null];
if (isset($_POST['altaDepartamento'])) {
...
if ($entradaOK) {//si el valor es true procesamos los datos recogidos
    ...
    $codigo = $_POST['CodDepartamentos'];
    $descripcion = $_POST['DescDepartamentos'];
    $valorNegocio = $_POST['VolumenNegocio'];

   

    if(!DepartamentoPDO::validaCodNoExiste($codigo)) {
        $aErrores['CodDepartamentos'] = "Departamento Duplicado";
    }else{
          DepartamentoPDO::altaDepartamento($codigo, $descripcion, $valorNegocio);
